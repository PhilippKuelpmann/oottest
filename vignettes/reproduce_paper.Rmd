...
```{r}
  create_likelihood_table(data_two_action_games, predictions_two_action_games)

```

create_likelihood_tables <- function() {
  output_table <- c()
  for (i in 1:14) {
    output_table <- rbind(output_table, get_log_lh(data_two_action_games, prediction = predictions_two_action_games[,,i])
  }
